...
<header class="header">
	...
	<nav class="menu">
		<div class="menu__brand">
			<a href="index.html">E-Sambongrejo</a>
		</div>
		<ul class="menu__list">
			<li class="menu__item"><a href="index.html" class="menu__link">Home</a></li>
			<li class="menu__item"><a href="produk.html" class="menu__link">Produk</a></li>
			<li class="menu__item"><a href="berita.html" class="menu__link">Berita</a></li>
			<li class="menu__item"><a href="video.html" class="menu__link">Video</a></li>
			<li class="menu__item"><a href="kontak.html" class="menu__link">Kontak</a></li>
		</ul>
	</nav>
</header>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container-fluid">
        <a class="navbar-brand js-scroll-trigger" href="index.html" style="color: black;">
			E-Sambongrejo</a>
      </div>
    </nav>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">                        
                        <h2> Selamat Datang Di Website Desa Sambongrejo</h2>
			...
			<div class="gallery-menu text-center row">
				<div class="col-md-12">
					<div class="button-group filter-button-group">
						...
						<button data-filter=".photo_a">Gorengan</button>
						<button data-filter=".photo_b">Keripik</button>
						<button data-filter=".photo_c">Hasil Bumi</button>
					</div>
				</div>
			</div>
			...
			<div class="gallery-list row">
					...
					<div class="gallery-single fix">
						...
						<div class="box-content">
							<div class="inner-content">
								<h3 class="title">Bakwan</h3>
								<span class="post">Bakwan Pontianak, disajikan dengan saus celup</span>
							</div>
							<ul class="icon">
				...
				<div class="col-md-4 col-sm-6 gallery-grid photo_b">
					<div class="gallery-single fix">
						...
						<div class="box-content">
							<div class="inner-content">
								<h3 class="title">Makaroni</h3>
								<span class="post">Lezat, Renyah, Pedas</span>
							</div>
							<ul class="icon">
					...
					<div class="gallery-single fix">
						...
						<div class="box-content">
							<div class="inner-content">
								...
								<span class="post">Wortel segar langsung dari perkebunan</span>
							</div>
							<ul class="icon">
				...
				<div class="col-md-4 col-sm-6 gallery-grid photo_a">
					<div class="gallery-single fix">
						...
						<div class="box-content">
							<div class="inner-content">
								<h3 class="title">Tahu Isi</h3>
								<span class="post">Berisi berbagai macam sayuran</span>
							</div>
							<ul class="icon">
				...
				<div class="col-md-4 col-sm-6 gallery-grid photo_b">
					<div class="gallery-single fix">
						...
						<div class="box-content">
							<div class="inner-content">
								<h3 class="title">Kerupuk</h3>
								<span class="post">Buatan rumahan, tanpa bahan kimia</span>
							</div>
							<ul class="icon">
				...
				<div class="col-md-4 col-sm-6 gallery-grid photo_c">
					<div class="gallery-single fix">
						...
						<div class="box-content">
							<div class="inner-content">
								<h3 class="title">Bawang Bombay</h3>
								<span class="post">Langsung dipetik dari lahan pertanian</span>
							</div>
							<ul class="icon">
				...
				<div class="col-md-4 col-sm-6 gallery-grid photo_a">
					<div class="gallery-single fix">
						...
						<div class="box-content">
							<div class="inner-content">
								<h3 class="title">Perkedel</h3>
								<span class="post">Berbahan dasar kentang tanpa msg dan pengawet</span>
							</div>
							<ul class="icon">
				...
				<div class="col-md-4 col-sm-6 gallery-grid photo_b">
					<div class="gallery-single fix">
						...
						<div class="box-content">
							<div class="inner-content">
								<h3 class="title">Keripik Tempe</h3>
								<span class="post">Berbahan 100% tempe tanpa bahan lain</span>
							</div>
							<ul class="icon">
					...
					<div class="gallery-single fix">
						...
						<div class="box-content">
							<div class="inner-content">
								...
								<span class="post">Ditanam dan dirawat tanpa bahan kimia berbahaya</span>
							</div>
							<ul class="icon">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="text">
						<a href="#" style="color: white; font-weight: bold; font-size: 30px;">
							E-Sambongrejo
						</a>
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					...
					<p class="ph-links-column">
						<a class="text-black">Jalan Seruni No 10 Sambongrejo, Kode Pos : 62191</a>
					</p>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12">
					<h4 class="mb-4 ph-fonts-style foot-title">
					...
					<p class="ph-links-column">
						...
						<a href="https://www.twitter.com" class="text-black">Twitter</a>
						<a href="https://www.pinterest.com" class="text-black">Pinterest</a>
						<a href="https://www.google.com/maps/place/Sambongrejo,+Sambong,+Kabupaten+Blora,+Jawa+Tengah/@-7.0945037,111.4976939,13z/data=!3m1!4b1!4m5!3m4!1s0x2e77662fba6dd4d1:0x5027a76e355d1c0!8m2!3d-7.0910434!4d111.5289438" class="text-black">Lokasi Maps</a>
					</p>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12">
					<h4 class="mb-4 ph-fonts-style foot-title">
					...
					<p class="ph-fonts-style_p">
						Dapatkan update rutin tentang desa kami
					</p>
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">                    
                    <p class="footer-company-name">All Rights Reserved. &copy; 2022 Design by : 
					<a href="https://html.design/">Haidar Hilmy Andana, A11.2020.13180</a> Distributed by: <a href="https://themewagon.com/">ThemeWagon</a>
                    </p>
                </div>
            </div>
        </div><!-- end container -->
